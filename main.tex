...
\input{regular/regular.tex}
\input{accepted-by-turing-machines.tex}
\input{context-free/context-free.tex}
\input{exercise-set-1.tex}
\input{exercise-set-2.tex}
\section{Exam Cheatsheets}
\input{exam-1-cheatsheet.tex}
\end{document}